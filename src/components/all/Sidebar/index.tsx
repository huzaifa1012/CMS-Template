...
import Logo from '../../../../public/about-half-logo.png';
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" style={{ display: "flex", justifyContent: 'center', alignItems: 'center' }}>
          ...
          &nbsp; &nbsp;<h1 style={{fontSize:"1.5rem"}}>Imperial look</h1>
        </NavLink>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('appointments')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('miscellaneous')
                }
              >
                {(handleClick, open) => {
                  return (
