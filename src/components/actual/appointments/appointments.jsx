...
const AppointmentsTable = () => {
  ...
  const fetchedData = async () => {
    try {
      const data = await getData('appointments', { appointmentstatus: "booked" });
      setAppointment(data)
  ...
  const askDelete = async (uid) => {
    Swal.fire({
      title: "Sure, Cancell this appointment?",
    ...
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="max-w-full overflow-x-auto">
        <button onClick={() => addData("appointments", {
          ...
          customeremail: "Afsanab@gmail.com",
          customername: "Afshan Agles",
          customerphone: "+9703233412",
          servicename: "Foot Scrub",
          serviceprice: "55"
        }
          , fetchedData()
