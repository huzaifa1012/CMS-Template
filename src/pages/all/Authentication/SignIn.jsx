...
import LogoDark from '../../../../public/about-half-logo.png';
...
const SignIn = () => {
  ...
  const handleSignin = async (event) => {
    ...
    if (email == "login@imperiallook.com" && password == "imperial@dubai151") {
      localStorage.setItem("loggedin", true)
      // alert("you've logged in successfully")
      window.location.href = '/appointments';  // This will navigate to the root URL
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block w-15" src={LogoDark} alt="Logo" />
                <img className="dark:hidden w-15" src={LogoDark} alt="Logo" />
              </Link>

              <p className="2xl:px-20">
                Imperial Look Content Management System
              </p>
